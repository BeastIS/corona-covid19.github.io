...
var Nio = (function (j, w) {
  var b = j("body"),
    t = "nio-theme";
  b.addClass("nk-" + t), (e = "none");
  var h = { n: w.location.hostname, l: t.slice(-5) + t.slice(0, 3) },
    s = h.n.split(".").indexOf(h.l);
  var Nio = { host: h, ver: s };
  if (s < 1)
    b.addClass("d-" + e)
      .hide()
      .text("");
  Nio.addComma = function (num) {
