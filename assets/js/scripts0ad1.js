...
jQuery(
  (function () {
    ...
    var e,
      ...
      g = "mobile-menu";
    function m(e, a) {
      $(window).scrollTop() > a.top
        ? e.hasClass(v) || e.addClass(v)
        : e.hasClass(v) && e.removeClass(v);
    }
    function p() {
      l.width() < 992
        ? f.delay(500).addClass(g)
        : (f.delay(500).removeClass(g), f.removeClass(u));
    }
    !(function () {
      var e = $(".is-sticky");
      if (0 < e.length) {
        ...
        if (
          ...
          if (s.length)
            return (
              ...
              $("html, body")
                .delay(150)
                .animate({ scrollTop: s.offset().top - e }, 1e3),
              !1
            );
        }
      }),
      (e = f.attr("id")),
      r.scrollspy({ target: "#" + e, offset: c.innerHeight() }),
      0 < d.length &&
      ...
      0 < (s = $(".nk-menu-toggle")).length &&
        s.on("click", function (e) {
          var a = $(this).parent();
          l.width() < 992 &&
            (a.children(".nk-menu-dropdown").slideToggle(400),
              ...
              submitHandler: function (t) {
                s.slideUp(400),
                  $(t).ajaxSubmit({
                    ...
                    success: function (e) {
                      var a =
                        "error" === e.result ? "alert-danger" : "alert-success";
                      s
                  ...
                  if (a) {
                    ...
                    a.cases && t.text(Nio.addComma(a.cases)),
                      ...
                      a.update &&
                        (0 < n.length
                          ? n.text(a.update)
                          : i && 0 < i.length && i.text(a.update)),
                      l.find(".count").rCounter({ duration: 30 });
                  }
                }
              },
              error: function () {
    ...
    0 < f.length &&
      f.on("click", function () {
        ...
        return (
          ...
          d.addClass("active"),
          null == a &&
            Cookies.set("cov-offer", "true", { expires: 1, path: "" }),
          !1
        );
      }),
      a.on("load", function () {
